...
public:
  void setUp() override
  {
    ...
    // AIF from Weinmann, H. J., Laniado, M., and W.M黷zel (1984). Pharmacokinetics of GD - DTPA / dimeglumine after intravenous injection into healthy volunteers. Phys Chem Phys Med NMR, 16(2) : 167?2.
    int D = 1;
    double a1 = 3.99;
    double m1 = 0.144;
    double a2 = 4.78;
